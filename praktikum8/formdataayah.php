...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty($_POST["thnLahir"])) {
            $error_thnLahir = "Kolom tanggal lahir tidak boleh kosong";
        } else {
            $thnLahir = cek_input($_POST["thnLahir"]);
            if (!is_numeric($thnLahir)) {
                $error_thnLahir = "Kolom tanggal lahir hanya boleh angka";
            }
        }
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="nmAyah" class="col-sm-2 col-form-label">Nama Ayah Kandung</label>
                        <div class="col-sm-10">
                            <input type="text" name="nmAyah" id="nmAyah" class="form-control <?php echo ($error_nmAyah !="" ? "is-invalid" : ""); ?>" placeholder="" value="<?php echo $nmAyah; ?>"> <span class="warning"><?php echo $error_nmAyah ?></span>
                        </div>
                    </div><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="radio" name="gajibulanan" value="500.000 - 999.9999"> 500.000 - 1.000.000 </label><br>
